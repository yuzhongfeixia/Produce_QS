...
public class HighlightView {
    ...
    protected void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (mCircle) {
                ...
                mOutlinePaint.setColor(0xFF0660CE);
            }
    ...
    void growBy(float dx, float dy) {
        ...
        // RectF r = new RectF(x, y, x + cropWidth, y + cropHeight);
        ...
        float minSize = Math.min(mImageRect.width(), mImageRect.height());
        if (r.width() > minSize || r.height() > minSize) {
            float centerX = r.centerX();
            float centerY = r.centerY();
            r.set(new RectF(centerX - minSize / 2, centerY - minSize / 2, centerX + minSize / 2,
                    centerY + minSize / 2));
        }
    ...
    public void setup(Matrix m, Rect imageRect, RectF cropRect, boolean circle,
        ...
        Log.d("lzc", "mInitialAspectRatio======================>" + mInitialAspectRatio);
        mDrawRect = computeLayout();
